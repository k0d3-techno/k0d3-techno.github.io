...
description: 'Another great CTF with solid pwn challenges—managed to solve one, and this write-up covers that. I’ll be updating as I explore more, while sharpening my ASM and reversing skills.'
date: 2025-03-13
...
![alt text](../../img/TRC_CTF/image-1.png)
...
![alt text](../../img/TRC_CTF/image.png)
