...
<Challenge
  ...
  points={306}
  solves={190}
  description="i gambled all of my life savings in this program (i have no life savings)"
...
<Challenge
  ...
  points={420}
  solves={94}
  description="TODO: finish the challenge"
...
<Challenge
  ...
  points={438}
  solves={77}
  description="I can READ ur aura."
  flag="UMDCTF{+100aur4}"
>
</Challenge>
...
<Challenge
  ...
  points={111}
  solves={390}
  description="the chall is not that complex. the key is to read ASSEMBLY!"
