...
description: 'First post in my all-in “Road to Final” series: a write-up of the two ASCIS 2024 pwn challenges I solved—skipping the heap-heavy Bug Bounty—on my quest for the Finals.'
